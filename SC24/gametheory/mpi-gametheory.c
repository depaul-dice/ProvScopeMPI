...
int main( int argc, char** argv ) {
    ...
    if(fscanf(file, "%f %f %f %f", &val1, &val2, &val3, &val4) != 4) {
	...
	if ( myRank == PLAYER_A_INDEX ) {
		/* Make player A "nice" */
		thisPlayer.probOfCooperateIfOppoCompeted = val1;
		thisPlayer.probOfCooperateIfOppoCooperated = val2;
		...
		thisPlayer.probOfCooperateIfOppoCompeted = val3;
		thisPlayer.probOfCooperateIfOppoCooperated = val4;
		thisPlayer.iCooperatedLastMove = True;
		thisPlayer.oppoCooperatedLastMove = True;
